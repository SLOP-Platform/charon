...
This package has ZERO knowledge of SLOP (ADR-0002 INV-B1/B5). The runtime guard
below fails loudly if SLOP was somehow pulled into the process.
"""
...
# ADR-0002 INV-B5 runtime guard: Charon must never share a process with SLOP.
