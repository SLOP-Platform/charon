...
def forward_via_router(handler, srv) -> bool:
    ...
    Returns True if served through the Router path; False if the hand-rolled path should run."""
    ...
    handler._send_resp_headers(200, ctype, provider, failovers, downgrade)
