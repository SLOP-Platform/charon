...
real-dep: |
  STAGE-DEMUX — added 2026-07-16. #26's premise is that the OOB grader's verdict is what EARNS
...
real-dep: |
  BENCH-PROVISIONAL-SCORING — shared single-owner of benchmark/bench.sh +
...
scope: |
  #26 (P0 INTEGRITY — the top fix; nothing the benchmark says is trustworthy until it lands).
