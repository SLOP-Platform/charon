...
substrate: |
  monit — ALREADY CHOSEN, never installed. fleet/watchdog/ ships generate-monit-config.sh,
  discover-services.sh and five rendered monit.d/*.conf. This ticket does not re-litigate the
  choice; it either completes the adoption or ends it honestly.
accept: |
