...
- If a manager-side task is too small to justify a tab, **do it inline and commit it in the same turn**. Never hand it to something invisible. An uncommitted deliverable is not a deliverable. `[verify-subagent-deliverable-files]`
