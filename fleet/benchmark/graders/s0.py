...
def main():
    ...
    if not only_providers:
        return common.emit(60, "pass", f"tests pass but touched files beyond providers.py: {changed}")
    ...
    if worktree_content.strip() == normalized_expected.strip():
        ...
        return common.emit(60, "pass", "tests pass, diff scoped to providers.py, but other tokens changed too")
