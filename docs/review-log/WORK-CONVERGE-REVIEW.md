...
- Coordinator doctrine v2: sourced from `/home/stack/charon-private/fleet/COORDINATOR-DOCTRINE-v2.md` (APPROVED 2026-07-08, 4-lens adversarial review, 21 decision narrowing, 13 rules, 6 open decisions)
- obol v2 design: sourced from `/home/stack/charon-private/fleet/PLAN-PORTABLE-ORCHESTRATION-STORE.md` (7 consensus blocker-fixes, 3 operator rulings, full schema + architecture)
